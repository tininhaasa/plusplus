                ...
                <ul class="navbar-nav ml-auto">
				  ...
				  <?php 
					if ($this->helpers['UserSession']->has()) { ?>
						<a href="<?= $url ?>/atividades" class="nav-link"  style="color: white;font-size: 20px;"><i class="fa-solid fa-circle-user" style="margin-right: 10px"></i><?= $this->helpers['UserSession']->get('username') ?></a>
