<div class="container-selecao d-flex flex-column">
    <div class="">
        ...
        <div class="svg d-flex flex-row mt-5">
            ...
            <svg width="285" height="229" viewBox="0 0 285 229" class="logical" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <svg style="margin-left: -15px;" width="240" class="align-self-center" height="17" viewBox="0 0 240 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0 8.5H239.019" stroke="#7E23BE" stroke-width="17" />
                        <path d="M0 8.5H239.019" stroke="#7E23BE" stroke-width="17" />
                    </svg>
